...
BASE_URL = "https://www.thriftycars4rent.com/api/geodata/search"

COUNTRY_CONFIG = {
   
    "US": ("thriftycars4rent.com", "ZT", "US", "us")

}

DOMAIN_TO_BOOKINGCOUNTRY = {
    cfg[0]: bookingcountry for bookingcountry, cfg in COUNTRY_CONFIG.items()
}


def get_bookingcountry_for_domain(domain):
    """Return the bookingcountry tied to a given domain."""
    return DOMAIN_TO_BOOKINGCOUNTRY.get(domain, "")
...
def build_input_data(target_terms=None):
    ...
    for iata, v in sorted(airports_db.items()):
        ...
        for bookingcountry, (domain, vendor, rate_source_group, locale) in COUNTRY_CONFIG.items():
            # explicit: bookingcountry is resolved by domain, not just the dict key
            resolved_bookingcountry = get_bookingcountry_for_domain(domain)
            assert resolved_bookingcountry == bookingcountry, (
                f"Domain/country mismatch: {domain} -> {resolved_bookingcountry} "
                f"vs config key {bookingcountry}"
            )
            ...
            rows.append(
                {
                    ...
                    "locale": locale,
                    "bookingcountry": resolved_bookingcountry,
                    "city": v["city"],
                    "airport_name": v["name"],
                }
            )
...
class thrifty:
    ...
    def _build_row(
        ...
        term, location_name, created_date, latitude, longitude,location_country
    ):
        return {
            "id": refid,
...
if __name__ == "__main__":
    ...
    RUN_MISSING_ONLY = 1
    MISSING_IATA_TERMS = terms = ["RQY", "RRG", "RRK", "RRL", "RRR", "RRS", "RRT", "RSA", "RSB", "RSD", "RSH", "RSI", "RSK", "RSL", "RSN", "RSS", "RST", "RSW", "RSU", "RTA", "RTB", "RTC", "RTG", "RTL", "RTM", "RTN", "RTP", "RTS", "RTY", "RTU", "RUD", "RUA", "RUE", "RUG", "RUI", "RUH", "RUK", "RUL", "RUM", "RUN", "RUP", "RUR", "RUS", "RUT", "RUV", "RUY", "RVA", "RVD", "RVE", "RVK", "RVI", "RVN", "RVO", "RVR", "RVS", "RVT", "RVV", "RVY", "RWI", "RWF", "RWL", "RWN", "RXE", "RXS", "RYB", "RYK", "RYN", "RZA", "RYO", "RZN", "RZE", "RZP", "RZR", "RZV", "RZZ", "SAA", "SAB", "SAC", "SAF", "SAD", "SAH", "SAI", "SAK", "SAL", "SAN", "SAO", "SAP", "SAR", "SAQ", "SAS", "SAT", "SAV", "SAU", "SAW", "SAY", "SAZ", "SBA", "SBD", "SBB", "SBE", "SBG", "SBH", "SBI", "SBJ", "SBK", "SBL", "SBM", "SBN", "SBO", "SBQ", "SBP", "SBR", "SBS", "SBT", "SBU", "SBW", "SBX", "SBY", "SBZ"]

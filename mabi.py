...
class mabi:
    ...
    def main(self, resultset):
        for result in resultset:
            ...
            country = result["country"] or "SE"
            source_url = (
                result["source_url"]
                or "https://www.mabi.se/api/WebStation/ReadAllStationDetails"
            )
            rows = []
            ...
            headers = {
                ...
                "authorization": "Basic RXh0X2FkbWluMToxMiFhekZydWt0",
                "content-type": "application/json;charset=UTF-8",
                "origin": "https://www.mabi.se",
                "referer": "https://www.mabi.se/eng",
            ...
            json_data = {"LanguageId": 56}

            try:
                proxies = self.get_proxy()
                try:
                    response = self.load(source_url, headers, json_data, proxies)
    ...
    def extraction(
        ...
        locations = response_data.get("Data", {}).get("WebStationDetails", [])
        ...
        for location in locations:
            ...
            row = {
                ...
                "location_country": country or "SE",
...
if __name__ == "__main__":
    SC = None
    try:
        # SC = mabi(0, 146, 146, "input_locations", "locations", False, "20")

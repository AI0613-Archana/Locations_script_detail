...
class hertz_3:
    ...
    def main(self, resultset):
        for result in resultset:
            ...
            source_url = (
                result["source_url"]
                or "https://www.hertz.com.cy/en/Resources/SearchBranchLocations"
            )
            headers = {
                ...
                "Origin": "https://www.hertz.com.cy",
                "Referer": "https://www.hertz.com.cy/en/",
            ...
            try:
                ...
                with ThreadPoolExecutor(max_workers=100) as executor:
                    ...
                    for iata in sorted(self.iata_codes):
                        ...
                        futures[
                            executor.submit(
                                self.load, source_url, headers, json_data, proxies
                            )
                        ] = (iata, json_data, proxies)

                    for future in as_completed(futures):
                        iata, json_data, proxies = futures[future]
                        try:
                            ...
                            response = self.load(source_url, headers, json_data, {})
    ...
    def extraction(
        ...
        locations = response_data.get("Locations", []) if isinstance(response_data, dict) else []
        ...
        for location in locations:
            ...
            location_country = re.sub(
                r"\s+", " ", str(location.get("Country") or country or "")
            ).strip()
            ...
            is_airport = True if iata_code or "AIRPORT" in location_term.upper() else False
            ...
            city = ""
            label_parts = [part.strip() for part in location_term.split(",") if part.strip()]
...
if __name__ == "__main__":
    ...
    SC = None
    try:
        # SC = hertz_3(0, 100, 100, "input_locations", "locations", False, "20")

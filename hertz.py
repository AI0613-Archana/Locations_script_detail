...
DIALECT_MAP = {
    "AE": "enGB", "BE": "frFR", "BG": "enGB", "BH": "enGB",
    "CH": "deCH", "CN": "zhCN", "CY": "enGB", "DE": "deDE",
    "DK": "daDK", "EE": "enGB", "ES": "esES", "FI": "fiFI",
    "FR": "frFR", "GB": "enGB", "GR": "enGB", "HR": "enGB",
    "IE": "enGB", "IL": "enGB", "IN": "enGB", "IT": "itIT",
    "JO": "enGB", "LB": "enGB", "LV": "enGB", "MA": "frFR",
    "MT": "enGB", "MU": "enGB", "NL": "nlNL", "NO": "noNO",
    "QA": "enGB", "RO": "enGB", "RS": "enGB", "RU": "ruRU",
    "SA": "enGB", "SE": "svSE", "SG": "enGB", "SI": "enGB",
    "CZ": "csCZ", "TH": "enGB", "TN": "frFR", "TR": "trTR",
    "UA": "enGB", "US": "enUS", "ZA": "enGB",
}
        ...
        for char in search_chars:
            try:
                ...
                for loc in locations:
                    ...
                    display   = loc.get("displayText", "").strip()
                    parts     = [p.strip() for p in display.split(",")]
                    iata_code = parts[0] if parts else oag   # fallback to oag if no displayText

...
BASE_URL = "https://prd.location.enterprise.com/enterprise-sls/search/location/national/web/text/{ss}"
...
class enterprise:
    def __init__(
        ...
        self.websitecode = 47          # ← update to Enterprise's actual websitecode
...
if __name__ == "__main__":
    EC = None
    try:
        EC = enterprise(0, 179, 179, "input_locations", "locations", False, "20", max_workers=10)
